$(function() {
    ...
    scrollUI();
        ...
        scrollGrowth('.class_information .class_overview')
        scrollGrowth('.class_information .awards_fairs')
        scrollGrowth('.enrolment .recruit')
        scrollGrowth('.enrolment .field')
    ...
    $('.interview article > a').on('click', function() {
        $('.interview article').addClass('more');
    });
    $('.enrolment .recruit ul li a').on('click', function() {
        $(this).parent('li').addClass('more');
    });
    $('.enrolment .curriculum .container > ul > li .only_m').on('click', function() {
        $(this).parents('li').addClass('more');
    });
    $('.enrolment .student_portfolio a.only_m').on('click', function() {
